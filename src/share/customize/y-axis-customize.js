...
class YAxisCustomize extends PureComponent {
        ...
        return (
            <View style={[style]}>
                ...
                >
                    ...
                    <Text
                        style={{ height: 0, color: 'transparent', fontSize: svg.fontSize }}
                    >
                        {longestValue}
                    </Text>
                    {
