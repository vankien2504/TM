...
export default class DocumentInputDetail extends Component {
    constructor(props) {
        super(props);
        this.state = {
            ...
            <View style={[styles.scene, { backgroundColor: '#EDEFF3' }]} >
                ...
                <View>
                    <View style={{ height: 40, flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.ChangePage('DocumentAddScreen', this.state.task, 'lich')}>
                            <Text
                    ...
                    <FlatList
                        ...
                        renderItem={({ item, index }) =>
                            <View style={[{ height: 40, flexDirection: 'row', backgroundColor: '#FFF', borderBottomColor: '#c3c3c3', borderBottomWidth: 1 }]}>
                                ...
                                />
                                <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.setState({ isChangeCalendar: index })}>
                                    <Image
                                        style={{ marginLeft: 0, marginTop: 12, marginRight: 27, height: 15, width: 14 }}
                                        source={require('../../assets/icons/edit.png')}
                                    />
                                </TouchableOpacity>
                                <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.DeleteOutput(item)}>
                                    <Image
                ...
                <View>
                    <View style={{ height: 40, flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.ChangePage('DocumentAddScreen', this.state.task, 'link')}>
                            <Text
                                style={{ marginTop: 11, marginLeft: 10, marginRight: 16, color: '#0092FF' }}
                            >
                                + thêm liên kết
                        ...
                        renderItem={({ item, index }) =>
                            <View>
                                ...
                                <View style={[{ height: 40, flexDirection: 'row', backgroundColor: '#FFF', borderBottomColor: '#c3c3c3', borderBottomWidth: 1 }]}>
                                    ...
                                    />
                                    <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.setState({ isChangeLinkMoTa: index })}>
                                        <Image
                                            style={{ marginLeft: 0, marginTop: 12, marginRight: 27, height: 15, width: 14 }}
                                            source={require('../../assets/icons/edit.png')}
                                        />
                                    </TouchableOpacity>
                                    <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.DeleteOutputFile(item)}>
                                        <Image
                                            style={{ marginLeft: 0, marginTop: 12, marginRight: 16, height: 15, width: 14 }}
                                            source={require('../../assets/icons/Trash.png')}
                                        />
                                ...
                                <View style={[{ height: 40, flexDirection: 'row', backgroundColor: '#FFF', borderBottomColor: '#c3c3c3', borderBottomWidth: 1 }]}>
                                    ...
                                    <TextInput
                                        ...
                                        onBlur={() => this.EditLink(item)}
                                    />
                                    <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.setState({ isChangeLink: index })}>
                                        <Image
                ...
                <View>
                    <View style={{ height: 40, flexDirection: 'row' }}>
                        ...
                        <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.ChangePage('DocumentAddScreen', this.state.task, 'file')}>
                            <Text
                                style={{ marginTop: 11, marginLeft: 10, marginRight: 16, color: '#0092FF' }}
                            >
                                + thêm đính kèm
                        ...
                        renderItem={({ item, index }) =>
                            <View>
                                ...
                                <View style={[{ height: 40, flexDirection: 'row', backgroundColor: '#FFF', borderBottomColor: '#c3c3c3', borderBottomWidth: 1 }]}>
                                    ...
                                    />
                                    <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.setState({ isChangeFileMoTa: index })}>
                                        <Image
                                            style={{ marginLeft: 0, marginTop: 12, marginRight: 27, height: 15, width: 14 }}
                                            source={require('../../assets/icons/edit.png')}
                                        />
                                ...
                                <View style={[{ height: 40, flexDirection: 'row', backgroundColor: '#FFF', borderBottomColor: '#c3c3c3', borderBottomWidth: 1 }]}>
                                    ...
                                    <TouchableOpacity style={this.state.task.IDNhanSuTao == GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.TakePhoto(item)}>
                                        <Text
                                            style={{ marginLeft: 16, lineHeight: 40, marginRight: 16, color: '#0092FF' }}
                                        > Tải lên</Text>
                                    </TouchableOpacity>
                                    <TouchableOpacity style={this.state.task.IDNhanSuTao != GLOBAL.userInfo.IDNhanSu ? { display: 'flex' } : { display: 'none' }} onPress={() => this.download(item)}>
                                        <Text
                                            style={{ marginLeft: 16, lineHeight: 40, marginRight: 16, color: '#0092FF' }}
                                        > Tải xuống</Text>
                                    </TouchableOpacity>
