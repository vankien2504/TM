...
export default class AgendaView extends Component {
  ...
  render() {
    ...
    const contentTranslate = this.state.scrollY.interpolate({
      inputRange: [0, agendaHeight],
      outputRange: [0, agendaHeight / 2 + 10],
      extrapolate: 'clamp',
    });
    ...
    return (
      <View onLayout={this.onLayout} style={[this.props.style, { flex: 1, overflow: 'hidden' }]}>
        ...
        <Animated.View style={[weekdaysStyle, { paddingTop: 0, paddingBottom: 0, paddingLeft: 0, paddingRight: 0, }]}>
          ...
          <View style={{ flex: 1, flexDirection: 'row', backgroundColor: '#FFF' }}>
            <TouchableOpacity style={{ flexDirection: 'row', }} onPress={() => { this.onTouchStart(), this.onTouchEnd() }}>
              <Text style={{ marginLeft: 24, fontSize: 15, fontWeight: 'bold', lineHeight: 42, width: 118 }}>  {moment(this.state.selectedDay).locale('en').format('MMMM YYYY')}</Text>
              <Image
                style={{ marginLeft: 16, marginTop: 18, height: 7, width: 12 }}
              ...
              <View style={{ flex: 1 }}></View>
                <TouchableOpacity onPress={() => this._chooseDayFromCalendar(Date())}>
              <Image
                style={{ marginRight: 37, marginTop: 10, height: 20, width: 20 }}
              ...
              <Image
                style={{ marginRight: 16, paddingRight: 0, marginTop: 11, height: 20, width: 20 }}
